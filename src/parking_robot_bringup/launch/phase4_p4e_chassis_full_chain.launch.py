"""Isolated fake-only P4-E chain using the chassis-compatible profiles."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    nav = PathJoinSubstitution([bringup, "config", "phase4_p4e_chassis_nav2_params.yaml"])
    ...
    gate = PathJoinSubstitution([bringup, "config", "phase4_p4e_gate_mock.yaml"])
    ...
    nodes = [
        ...
        Node(package="vehicle_cmd_safety", executable="phase4_p4c_permission_fixture",
             name="phase4_p4e_permission_fixture", output="screen",
