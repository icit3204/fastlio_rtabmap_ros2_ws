...
def generate_launch_description() -> LaunchDescription:
    ...
    declare_args = [
        ...
        # DeclareLaunchArgument('database_path', default_value='./map/rtabmap_infra_0609_afternoon_superpoint_superglue_3D.db'),
        # DeclareLaunchArgument('database_path', default_value='./map/rtabmap_infra_0604_night_and_0609_afternoon_superpoint_superglue_3D.db'),
#        DeclareLaunchArgument('database_path', default_value='./map/rtabmap_infra_0604_night_superpoint_superglue_3D.db'),
    ...
    collision_monitor = Node(
        ...
        parameters=[{
            ...
            'StopZone.points': [ 0.70, 0.30, 0.70, -0.70, 0.0, -0.70, 0.0, 0.30],
            ...
            'SlowZone.points': [0.55, 0.20, 0.55, -0.50, -0.55,-0.50, -0.55, 0.20],
